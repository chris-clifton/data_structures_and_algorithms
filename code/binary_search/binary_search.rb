...
# it has room for improvement. This should be refactoredto use index pointers
...
# TODO: Is having @steps += 1 at the bottom correct? Wouldn't that mean that if we
#       land on the @search_target as the first current_index that we'd have 0 steps?
#       Need to figure that out before I say this "works".

# Given an array of numbers, perform a binary search and return the number of
# steps it takes to complete.
#
# ex: binary_search = BinarySearch.new(search_target: 4, ordered_array: [1, 2, 3, 4, 5, 6]).perform
#     binary_search => 4

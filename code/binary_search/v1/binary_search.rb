...
# TODO: 
# 1. Having @steps += 1 at the end of the loop cant be right. That would mean
...
# 2. Remove the rescue and pry
# 3. Validate and order the array

# Given an array, perform a binary search and return the number of
